...
제한된 저출력 레지스터 write/read-back과 정확 복원을 수행했습니다. 다른 제품군의 쓰기 가능
항목은 여전히 스키마 선언일 뿐 실제 장비 쓰기 검증 결과가 아닙니다. Pro에서도 물리 유량과
파형은 검증하지 않았습니다.
...
| Local Wavemaker Pro (WiFi+BLE) | 2 | wavemaker | 성공 | 성공·정확 복원 |
